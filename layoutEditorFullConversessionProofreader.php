...
<title>Full Conversession with Proofreader</title>
...
<body>
	<?php include_once("layoutEditorNavigationBar.php"); ?>
        ...
        <div class="editor-copy-editor-message-container">
          ...
          <h1>Full conversession with Proofreaders</h1>  
          
          <!--<a name="author-bottom"></a>-->  
          
          <div class="editor-copy-editor-comment w3-card-4">
              <strong style="display:block;">Adam Ratner(Layout Editor)</strong>
          ...
          <div class="editor-comment w3-card-4">
              <strong style="display:block;">Mahir Faisal(Proofreader)</strong>
