...
<style>
    ...
    padding-right:50px; position:fixed; z-index:1000; ">
        ...
        <ul class="w3-navbar" style="float:right; height:40px; margin-top:30px;">
          <li><a class="header-link make-active w3-hover-red" href="copyEditorLoggedin.php"><i class="fa fa-user" aria-hidden="true"></i>Profile</a></li>
          ...
          <li class="w3-dropdown-hover w3-hover-red">
            ...
            <div class="w3-dropdown-content w3-white w3-card-4 w3-animate-zoom" style="background-color:red;">
              <a class="w3-hover-green" href="copyEditorThreadMessageSe.php">Section Editor</a>
              <a class="w3-hover-green" href="copyEditorThreadMessageAuthor.php">Author</a>       
            </div>
          </li>   
          ...
          <li class="w3-dropdown-hover w3-hover-red">
            ...
            <div class="w3-dropdown-content w3-white w3-card-4 w3-animate-zoom" style="background-color:red;">
              <a class="w3-hover-green" href="copyEditorCopyEditableArticle.php">From Section Editor</a>
              <a class="w3-hover-green" href="copyEditorArticlesFromAuthor.php">From Author</a>       
            </div>
          </li> 
          
          <!--<li class="w3-dropdown-hover w3-hover-red">
            <a class="header-link w3-hover-red"><i class="fa fa-envelope" aria-hidden="true"></i>Send Copyedited Article <i class="fa fa-caret-down"></i></a>
            <div class="w3-dropdown-content w3-white w3-card-4 w3-animate-zoom" style="background-color:red;">
              <a style="cursor:pointer;" class="w3-hover-green" 
              onClick="document.getElementById('notifyMessageId').style.display='block'">
              To Section Editor</a>
              <a style="cursor:pointer;" class="w3-hover-green" 
              onClick="document.getElementById('notifyAuthorMessageId').style.display='block'">To Author</a>       
            </div>
          </li> -->
             
          <li><a class="header-link make-active w3-hover-red" href="authorLogout.php">
