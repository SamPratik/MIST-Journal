...
<head>
<meta charset="utf-8">
<title>Message threads(Layouteditors)</title>
...
<body>
    ...
    <div class="editor-section-editor-message-thread">
    	  ...
    	  <h1>Messages of Layouteditors</h1>
          
          <ul class="w3-ul">
            <li class="w3-hover-light-grey">
              <a class="w3-hover-light-grey" href="sectionEditorFullConversessionLayoutEditor.php">
