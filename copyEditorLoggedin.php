...
<body>
    ...
    <?php  
		$ceSelectProfile = "SELECT * FROM copy_editor WHERE id=$ceLoginId";
		
		$ceResultProfile = mysqli_query($connection,$ceSelectProfile);
		$ceRowProfile = mysqli_fetch_assoc($ceResultProfile);
	?>
    ...
    <div class="editor-prfile-container">
    	<table>
        	<tr>
                ...
                <td class="col2"><?php echo $ceRowProfile["ceFn"]. " " .$ceRowProfile["ceLn"]; ?></td>
                <td class="col3"></td>		
            </tr>
