...
<body>
    ...
    <?php  
		$rSelectProfile = "SELECT * FROM reviewer WHERE id=$rLoginId";
		
		$rResultProfile = mysqli_query($connection,$rSelectProfile);
		$rRowProfile = mysqli_fetch_assoc($rResultProfile);
	?>
    ...
    <div class="editor-prfile-container">
    	<table>
        	<tr>
                ...
                <td class="col2"><?php echo $rRowProfile["rFn"]. " " .$rRowProfile["rLn"]; ?></td>
                <td class="col3"></td>		
            </tr>
