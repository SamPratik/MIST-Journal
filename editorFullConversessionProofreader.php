...
<style>
	...
	* {
	...
	.editor-proofreader-message-container {
		position:relative;
		top:110px;
		min-height:400px;
		width:80%;
	...
	.editor-proofreader-message-container h1 {
		color:#32CD99;
...
<body>
	<?php include_once("editorNavigationBar.php"); ?>
        ...
        <div class="editor-proofreader-message-container">
        
          <h1>Full conversession with Copyeditor</h1>  
          
          <!--<a name="author-bottom"></a>-->  
          
          <div class="editor-proofreader-comment w3-card-4">
              <strong style="display:block;">Adam Ratner(Copyeditor)</strong>
          ...
          <div class="editor-comment w3-card-4">
              <strong style="display:block;">Editor</strong>
