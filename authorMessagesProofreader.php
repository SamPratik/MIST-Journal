...
<style>
	...
	* {
	...
	.author-proofreader-message-container {
		position:relative;
		top:110px;
		min-height:400px;
		width:80%;
	...
	.author-proofreader-message-container h1 {
		color:#32CD99;
...
<body>
	<?php include_once("authorNavigationBar.php"); ?>
        ...
        <div class="author-proofreader-message-container">
        
          <h1>Author & Prrofreader conversession</h1>  
          
          <!--<a name="author-bottom"></a>-->  
          
          <div class="author-proofreader-comment w3-card-4">
              <strong style="display:block;">Adam Ratner(Proofreader)</strong>
