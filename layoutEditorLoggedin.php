...
<body>
    ...
    <?php  
		$leSelectProfile = "SELECT * FROM layout_editor WHERE id=$leLoginId";
		
		$leResultProfile = mysqli_query($connection,$leSelectProfile);
		$leRowProfile = mysqli_fetch_assoc($leResultProfile);
	?>
    ...
    <div class="editor-prfile-container">
    	<table>
        	<tr>
                ...
                <td class="col2"><?php echo $leRowProfile["leFn"]. " " .$leRowProfile["leLn"]; ?></td>
                <td class="col3"></td>		
            </tr>
