...
<body>
    ...
    <?php  
		$pSelectProfile = "SELECT * FROM proofreader WHERE id=$pLoginId";
		
		$pResultProfile = mysqli_query($connection,$pSelectProfile);
		$pRowProfile = mysqli_fetch_assoc($pResultProfile);
	?>
    ...
    <div class="editor-prfile-container">
    	<table>
        	<tr>
                ...
                <td class="col2"><?php echo $pRowProfile["pFn"]. " " .$pRowProfile["pLn"]; ?></td>
                <td class="col3"></td>		
            </tr>
